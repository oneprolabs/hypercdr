...
export function RecoveryWizardModal(props: Props) {
  ...
  const submitDisabled = !config.pointId || !config.targetCluster || !targetNamespace.trim() || restorePointUnavailable || (restoresToOriginalNamespace && !config.originalNamespaceConfirmed);
