...
GOPROXY=https://goproxy.cn,direct \
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 \
go build -trimpath -ldflags='-s -w' -o /data/hypercdr/hypercdr-platform/comm-agent ./cmd/comm-agent
```
...
```bash
cd /data/hypercdr/hypercdr-velero/velero-1.17.1
...
当前脚本已经固化在平台源码的 `deployments/release` 目录：

```text
/data/hypercdr/hypercdr-platform/deployments/release/release-all.sh <version>
/data/hypercdr/hypercdr-platform/deployments/release/build-release.sh <version>
/data/hypercdr/hypercdr-platform/deployments/release/push-release.sh <version>
/data/hypercdr/hypercdr-platform/deployments/release/deploy-platform.sh <version>
/data/hypercdr/hypercdr-platform/deployments/release/verify-platform.sh
```
...
```text
/data/hypercdr/hypercdr-platform/deployments/release/release.conf
```
...
```text
/data/hypercdr/hypercdr-velero/velero-1.17.1/deployments/build-velero-image.sh
```
