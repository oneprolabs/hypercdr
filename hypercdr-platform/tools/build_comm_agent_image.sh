...
BUILD_ROOT="${HCDR_BUILD_ROOT:-${WORKSPACE_DIR}/.build/comm-agent}"
CACHE_ROOT="${HCDR_CACHE_ROOT:-${WORKSPACE_DIR}/.cache}"
...
cp "${ROOT_DIR}/deployments/docker/comm-agent.local.Dockerfile" "${WORK_DIR}/Dockerfile"
echo "==> Building ${IMAGE}"
