...
CA_FILE="${HCDR_REGISTRY_CA_FILE:-${SCRIPT_DIR}/charts/hypercdr-platform/files/registry-ca.crt}"
RESTART_DOCKER="false"

usage() {
  cat <<'USAGE'
Prepare Docker to trust the HyperCDR Harbor registry certificate.
...
Options:
  ...
  --ca-file PATH      CA certificate file, default: charts/hypercdr-platform/files/registry-ca.crt.
