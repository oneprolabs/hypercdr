...
IMAGE_TAG="${HCDR_VELERO_IMAGE_TAG:-v1.18.2-hcdr.1}"
VELERO_VERSION="${HCDR_VELERO_VERSION:-v1.18.2-hcdr.1}"
UPSTREAM_COMMIT="${HCDR_VELERO_UPSTREAM_COMMIT:-c253c7fe37d78c9b7e55c68544f7c5b2608712d8}"
