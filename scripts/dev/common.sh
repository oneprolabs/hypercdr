...
HCDR_DEV_CONFIG="${HCDR_DEV_CONFIG:-${HCDR_RUNTIME_ROOT}/environments/community/dev.conf}"
...
HCDR_DEV_DIR="${HCDR_DEV_DIR:-${HCDR_RUNTIME_ROOT}/environments/community}"
...
HCDR_DEV_TLS_CERT_FILE="${HCDR_DEV_TLS_CERT_FILE:-${HCDR_RUNTIME_ROOT}/shared/certs/platform.crt}"
HCDR_DEV_TLS_KEY_FILE="${HCDR_DEV_TLS_KEY_FILE:-${HCDR_RUNTIME_ROOT}/shared/certs/platform.key}"
